...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="" class="brand-link" style=" background: linear-gradient(45deg, rgba(5,118,255,1) 0%, rgba(36,248,255,1) 100%)">
        <img src="{{ asset('img/favicon.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3">
        <span class="brand-text font-weight-light" style="color: white"><b>SIAKAD</b></span>
    </a>

    <!-- Sidebar -->
    <div class="sidebar" style="background-color: rgba(49, 49, 49, 0.747)">
        <!-- Sidebar Menu -->
        <nav class="mt-2">
