            ...
            <div class="card-body">
                ...
                <div class="position-relative mb-4">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <ul class="chart-legend clearfix">
                                <li><i class="far fa-circle" style="color: #ba6906"></i> Nautika Kapal Niaga</li>
                                <li><i class="far fa-circle" style="color: #ff990a"></i> Teknika Kapal Niaga</li>
                                <li><i class="far fa-circle" style="color: #0b2e75"></i> Teknik Electro</li>
                                <li><i class="far fa-circle" style="color: #7980f7"></i> Teknik Kendaraan Ringan</li>
                            </ul>
                        </div>
                    </div>
                </div>
